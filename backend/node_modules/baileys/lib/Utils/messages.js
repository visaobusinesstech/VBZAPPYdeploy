...
const convertlidDevice = (jid, lid, meid, melid) => {
    var _a, _b, _c, _d, _e;
    const meLiidiser = (_a = (0, WABinary_1.jidDecode)(melid)) === null || _a === void 0 ? void 0 : _a.user;
    const mejidUser = (_b = (0, WABinary_1.jidDecode)(meid)) === null || _b === void 0 ? void 0 : _b.user;
    const jidUser = (_c = (0, WABinary_1.jidDecode)(jid)) === null || _c === void 0 ? void 0 : _c.user;
    const jidDevice = (_d = (0, WABinary_1.jidDecode)(jid)) === null || _d === void 0 ? void 0 : _d.device;
    ...
    const lidUser = (_e = (0, WABinary_1.jidDecode)(lid)) === null || _e === void 0 ? void 0 : _e.user;
