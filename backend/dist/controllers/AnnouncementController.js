...
exports.deleteMedia = exports.mediaUpload = exports.unacknowledge = exports.acknowledge = exports.getAnnouncementsForCompany = exports.findList = exports.remove = exports.update = exports.show = exports.store = exports.index = void 0;
...
const store = async (req, res) => {
    ...
    logger_1.default.info({ msg: "announcement:create", id: record.id, companyId });
...
const update = async (req, res) => {
    ...
    logger_1.default.info({ msg: "announcement:update", id, companyId });
    const io = (0, socket_1.getIO)();
    io.of(String(companyId))
        .emit(`company-announcement`, {
        action: "update",
...
const remove = async (req, res) => {
    ...
    logger_1.default.info({ msg: "announcement:delete", id, companyId });
    const io = (0, socket_1.getIO)();
    io.of(String(companyId))
        .emit(`company-announcement`, {
        action: "delete",
...
const getAnnouncementsForCompany = async (req, res) => {
    const { searchParam, pageNumber } = req.query;
    const { companyId } = req.user;
    const { records, count, hasMore } = await (0, ListService_1.default)({
        searchParam,
    ...
    logger_1.default.info({ msg: "announcement:list:company", companyId, count });
    return res.json({ records, count, hasMore });
};
exports.getAnnouncementsForCompany = getAnnouncementsForCompany;
const acknowledge = async (req, res) => {
    ...
    if (announcement.targetCompanyId && Number(announcement.targetCompanyId) !== Number(companyId)) {
        throw new AppError_1.default("ERR_FORBIDDEN_ACK_TARGET_COMPANY", 403);
    }
    await AnnouncementAck_1.default.findOrCreate({
        where: { announcementId: Number(id), companyId },
        defaults: { announcementId: Number(id), companyId }
    });
    logger_1.default.info({ msg: "announcement:ack", id: Number(id), companyId });
    const io = (0, socket_1.getIO)();
    io.of(String(companyId))
        .emit(`company-announcement`, {
        action: "ack",
...
const unacknowledge = async (req, res) => {
    const { id } = req.params;
    const { companyId } = req.user;
    await AnnouncementAck_1.default.destroy({ where: { announcementId: Number(id), companyId } });
    const announcement = await Announcement_1.default.findByPk(id);
    if (announcement?.targetCompanyId && Number(announcement.targetCompanyId) !== Number(companyId)) {
        throw new AppError_1.default("ERR_FORBIDDEN_ACK_TARGET_COMPANY", 403);
    }
    logger_1.default.info({ msg: "announcement:unack", id: Number(id), companyId });
    const io = (0, socket_1.getIO)();
    io.of(String(companyId))
        .emit(`company-announcement`, {
        action: "unack",
...
exports.unacknowledge = unacknowledge;
