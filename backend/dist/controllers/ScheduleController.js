...
const store = async (req, res) => {
    const { body, sendAt, contactId, userId, ticketUserId, queueId, openTicket, statusTicket, whatsappId, intervalo = 1, valorIntervalo = 0, enviarQuantasVezes = 1, tipoDias = 4, contadorEnvio = 0, assinar = false, 
    // ✅ Campos de lembrete
    reminderDate, reminderMessage } = req.body;
    const { companyId } = req.user;
