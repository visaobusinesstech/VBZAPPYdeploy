...
const BirthdaySettings_1 = __importDefault(require("./BirthdaySettings"));
...
__decorate([
    ...
    sequelize_typescript_1.Column,
    __metadata("design:type", Boolean)
], Company.prototype, "generateInvoice", void 0);
__decorate([
    sequelize_typescript_1.Column,
    __metadata("design:type", String)
...
__decorate([
    (0, sequelize_typescript_1.HasMany)(() => BirthdaySettings_1.default, {
        onUpdate: "CASCADE",
        onDelete: "CASCADE",
        hooks: true
    }),
    __metadata("design:type", Array)
], Company.prototype, "birthdaySettings", void 0);
Company = __decorate([
