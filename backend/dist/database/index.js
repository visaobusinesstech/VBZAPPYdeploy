...
const FlowDoc_1 = require("../models/FlowDoc");
...
const QueueStates_1 = __importDefault(require("../models/QueueStates"));
const TicketFinalizationReason_1 = __importDefault(require("../models/TicketFinalizationReason"));
const PresetWebhook_1 = __importDefault(require("../models/PresetWebhook"));
...
const models = [
    ...
    Versions_1.default,
    QuickMessageComponent_1.default,
    ...
    FlowDoc_1.FlowDocModel,
    Webhook_1.WebhookModel,
    QueueStates_1.default,
    TicketFinalizationReason_1.default,
    PresetWebhook_1.default,
    BirthdaySettings_1.default,
    WhatsapplidMap_1.default,
    CallHistory_1.default,
    CompanyKanbanConfig_1.default,
    MessageApi_1.default
];
