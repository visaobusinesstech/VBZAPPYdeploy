...
contactRoutes.post("/contacts/bulk-delete", isAuth_1.default, ContactController.bulkDelete);
contactRoutes.delete("/contacts/all", isAuth_1.default, ContactController.deleteAll);
contactRoutes.post("/contacts/import", isAuth_1.default, ImportPhoneContactsController.store);
contactRoutes.get("/contacts/:contactId/participants", isAuth_1.default, ContactController.getGroupParticipants);
contactRoutes.get("/contacts/:contactId/media", isAuth_1.default, ContactController.getContactMedia);
contactRoutes.get("/contacts/:contactId/messages/search", isAuth_1.default, ContactController.searchMessages);
...
contactRoutes.get("/contacts/wallets", isAuth_1.default, ContactController.listWallets);
...
contactRoutes.put("/contacts/wallet/:contactId", isAuth_1.default, ContactController.updateContactWallet);
contactRoutes.delete("/contacts/wallet/:contactId", isAuth_1.default, ContactController.deleteContactWallet);
