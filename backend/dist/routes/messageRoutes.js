...
messageRoutes.post("/messages-template/:ticketId", isAuth_1.default, upload.array("medias"), MessageController.storeTemplate);
messageRoutes.post("/message/transcribeAudio", isAuth_1.default, MessageController.transcribeAudioMessage);
