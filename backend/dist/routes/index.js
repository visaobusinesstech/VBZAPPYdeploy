...
const ticketFinalizationReasonRoutes_1 = __importDefault(require("./ticketFinalizationReasonRoutes"));
const presetWebhookRoutes_1 = __importDefault(require("./presetWebhookRoutes"));
const birthdayRoutes_1 = __importDefault(require("./birthdayRoutes"));
...
const companyKanbanRoutes_1 = __importDefault(require("./companyKanbanRoutes"));
const metaRoutes_1 = __importDefault(require("./metaRoutes"));
const ChatController_1 = __importDefault(require("../controllers/ChatController"));
const routes = (0, express_1.Router)();
routes.use("/v1", metaRoutes_1.default);
...
routes.use(birthdayRoutes_1.default);
...
routes.use("/call", callRoutes_1.default);
routes.use(companyKanbanRoutes_1.default);
routes.post("/chats/backfill", ChatController_1.default.backfillChats);
