...
userRoutes.put("/users/:userId/online", isAuth_1.default, UserController.updateOnlineStatus);
userRoutes.get("/users/online", isAuth_1.default, UserController.getOnlineUsers);
