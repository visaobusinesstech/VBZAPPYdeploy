...
routes.get("/campaigns/:id/recurrence-preview", isAuth_1.default, CampaignController.previewRecurrence);
routes.post("/campaigns/:id/stop-recurrence", isAuth_1.default, CampaignController.stopRecurrence);
...
routes.get("/campaigns/:id/shipping", isAuth_1.default, CampaignController.getShipping);
routes.get("/campaigns/:id/stats", isAuth_1.default, CampaignController.getStats);
