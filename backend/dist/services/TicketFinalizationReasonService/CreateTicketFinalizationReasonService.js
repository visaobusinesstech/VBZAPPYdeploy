...
const CreateTicketFinalizationReasonService = async ({ name, description, companyId }) => {
    ...
    const reason = await TicketFinalizationReason_1.default.create({
        name,
        description,
        companyId
    });
...
exports.default = CreateTicketFinalizationReasonService;
