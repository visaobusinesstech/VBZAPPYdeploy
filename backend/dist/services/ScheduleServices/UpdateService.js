...
const UpdateUserService = async ({ scheduleData, id, companyId }) => {
    ...
    const { body, sendAt, sentAt, contactId, ticketId, userId, ticketUserId, queueId, openTicket, statusTicket, whatsappId, intervalo, valorIntervalo, enviarQuantasVezes, tipoDias, assinar, 
    // ✅ Campos de lembrete
    reminderDate } = scheduleData;
    try {
