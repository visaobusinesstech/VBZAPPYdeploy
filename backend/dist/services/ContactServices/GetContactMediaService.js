...
const GetContactMediaService = async ({ contactId, companyId }) => {
    ...
    const linkMessages = await Message_1.default.findAll({
        where: {
            ticketId: {
                [sequelize_1.Op.in]: ticketIds
            },
            body: {
                [sequelize_1.Op.regexp]: "(https?://[^\\s]+)" // Regex para encontrar URLs
            },
            mediaUrl: null,
            isDeleted: false
        },
...
exports.default = GetContactMediaService;
