...
class RecurrenceService {
    static calculateNextExecution(lastExecution, config) {
        const lastMoment = (0, moment_1.default)(lastExecution);
        let nextExecution;
        switch (config.type) {
            case 'minutely':
            ...
            case 'yearly':
                ...
                break;
            default:
                throw new AppError_1.default('Tipo de recorrência inválido', 400);
        }
        return nextExecution.toDate();
    }
    static calculateNextWeeklyExecution(lastMoment, config) {
    ...
    static calculateNextMonthlyExecution(lastMoment, config) {
    ...
    static shouldContinueRecurrence(campaign) {
        const now = new Date();
    ...
    static async scheduleNextExecution(campaignId) {
...
exports.default = RecurrenceService;
