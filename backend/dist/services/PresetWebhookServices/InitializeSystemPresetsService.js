...
exports.InitializeSystemPresetsService = void 0;
const PresetWebhook_1 = require("../../models/PresetWebhook");
const InitializeSystemPresetsService = async () => {
    try {
        // Verificar se presets do sistema já existem
        const existingPresets = await PresetWebhook_1.PresetWebhookModel.findAll({
            where: { isSystem: true }
        });
        ...
        await PresetWebhook_1.PresetWebhookModel.create(kiwifyPreset);
...
exports.InitializeSystemPresetsService = InitializeSystemPresetsService;
