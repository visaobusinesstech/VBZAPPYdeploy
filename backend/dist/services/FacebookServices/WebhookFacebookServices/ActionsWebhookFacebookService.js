...
const ActionsWebhookFacebookService = async (token, idFlowDb, companyId, nodes, connects, nextStage, dataWebhook, details, hashWebhookId, pressKey, idTicket, numberPhrase, msg) => {
...
const switchFlow = async (msg, companyId, ticket) => {
    ...
    (0, flowBuilderQueue_1.default)(ticket, msg, wbot, whatsapp, companyId, ticket?.contact, null);
};
