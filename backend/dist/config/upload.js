        ...
        destination: async function (req, file, cb) {
            ...
            if (typeArch === "user") {
                ...
                if (typeArch === "fileList") {
                    ...
                    folder = path_1.default.resolve(publicFolder, `company${companyId}`, typeArch, fileId ? String(fileId) : "");
                }
                else {
                    folder = path_1.default.resolve(publicFolder, `company${companyId}`, typeArch, userId ? userId : "");
                }
            }
                ...
                folder = path_1.default.resolve(publicFolder, `company${companyId}`, typeArch);
            }
        ...
        filename(req, file, cb) {
            ...
            if (file.mimetype && file.mimetype.startsWith('audio/')) {
                ...
                const fileName = typeArch && !["chat", "announcements"].includes(typeArch)
                    ? `${path_1.default.parse(file.originalname).name}_${timestamp}${extension}`
