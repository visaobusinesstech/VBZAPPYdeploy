...
exports.REDIS_URI_CONNECTION = process.env.REDIS_URI || process.env.REDIS_URL || process.env.IO_REDIS_SERVER || "";
...
exports.REDIS_SECRET_KEY = process.env.REDIS_SECRET_KEY || "WCHAT";
exports.REDIS_URI_MSG_CONN = process.env.REDIS_URI_ACK || process.env.REDIS_URL || process.env.IO_REDIS_SERVER || '';
